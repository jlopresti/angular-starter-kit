 ...
 */
export class ModalFooter implements ng.IComponentOptions {
   ...
   * @type {Function}
   */
  public controller: Function = ModalFooterController
   ...
   * @type {string}
   */
  public template: string = require('./modal-footer.html').toString()
...
/**
 * ModalFooter - Controller
 *
 * @export
 * @class ModalFooterController
 */
export class ModalFooterController {
  ...
  constructor(public $log: any) {
    this.$log = $log.getInstance('ModalFooter');
