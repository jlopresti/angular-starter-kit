 ...
 */
export class ModalBody implements ng.IComponentOptions {
   ...
   * @type {Function}
   */
  public controller: Function = ModalBodyController
   ...
   * @type {string}
   */
  public template: string = require('./modal-body.html').toString()
...
/**
 * ModalBody - Controller
 *
 * @export
 * @class ModalBodyController
 */
export class ModalBodyController {
  ...
  constructor(public $log: any) {
    this.$log = $log.getInstance('ModalBody');
