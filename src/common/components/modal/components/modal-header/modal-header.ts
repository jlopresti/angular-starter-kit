 ...
 */
export class ModalHeader implements ng.IComponentOptions {
   ...
   * @type {Function}
   */
  public controller: Function = ModalHeaderController
   ...
   * @type {string}
   */
  public template: string = require('./modal-header.html').toString()
...
/**
 * ModalHeader - Controller
 *
 * @export
 * @class ModalHeaderController
 */
export class ModalHeaderController {
  ...
  constructor(public $log: any) {
    this.$log = $log.getInstance('ModalHeader');
