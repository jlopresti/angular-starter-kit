 ...
 */
export class ModalTest implements ng.IComponentOptions {
   ...
   * @type {Function}
   */
  public controller: Function = ModalTestController
   ...
   * @type {string}
   */
  public template: string = require('./modal-test.html').toString()
...
/**
 * ModalTest - Controller
 *
 * @export
 * @class ModalTestController
 */
export class ModalTestController {
  ...
  constructor(public $log: any) {
    this.$log = $log.getInstance('ModalTest');
